// Paramètres de rendu des réflexions
#define MAX_RAYS 16          // Nombre maximum d'itérations du rayon
#define MAX_REFINEMENTS 4    // Nombre maximum d'étapes de raffinement
#define RAY_MULT 2.0         // Multiplicateur de progression du rayon
#define REFINEMENT_MULT 0.1  // Multiplicateur pour phase de raffinement

// Calcule l'effet de vignette pour adoucir les bords des réflexions
...
// Fonction principale de calcul des réflexions
